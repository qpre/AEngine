...
(function() {
  ...
  */
  ...
  AE.States.GamePhaseManager = (function(_super) {

    __extends(GamePhaseManager, _super);

    GamePhaseManager.prototype._phases = null;

    GamePhaseManager.prototype._current = null;

    function GamePhaseManager() {
      this._phases = {};
    }
    ...
    */
    ...
    GamePhaseManager.prototype.has = function(phase) {
    ...
    */
    ...
    GamePhaseManager.prototype.addPhase = function(name, actionIn, actionOut, run) {
      if (this.has(name)) {
    ...
    */
    ...
    GamePhaseManager.prototype.setCurrent = function(current) {
    ...
    */
    ...
    GamePhaseManager.prototype.transitionTo = function(next) {
  ...
  AE.Engine = (function(_super) {
    ...
    Engine._gamePhases = null;

    Engine._messageBox = null;

    function Engine() {}

    Engine.prototype.PhasesManager = function() {
      if (!this._gamePhases) {
        this._gamePhases = new AE.States.GamePhasesManager();
      }
      return this._gamePhases;
    };
